...
public class ViewPagerActivity extends Activity {
	...
	static class SamplePagerAdapter extends PagerAdapter {
		...
		private static final int[] sDrawables = { R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper, R.drawable.wallpaper };
