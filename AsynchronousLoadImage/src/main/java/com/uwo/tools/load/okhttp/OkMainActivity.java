...
import com.uwo.tools.load.okhttp.callback.ResultCallback;
...
public class OkMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new OkHttpAdapter(this));
    }
...
//        }.start();
    ...
    public void uploadFile(View view) {
        ...
        if (!file.exists()) {
            Toast.makeText(OkMainActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        }
