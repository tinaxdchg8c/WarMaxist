package com.uwo.tools.aibum.refresh.flyrefresh;
...
import com.uwo.tools.aibum.refresh.flyrefresh.view.FlyRefreshLayout;
...
public class FlyRefreshMainActivity extends AppCompatActivity implements FlyRefreshLayout.OnPullRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDataSet();
        setContentView(R.layout.activity_flyrefresh_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_flyrefresh_main, menu);
        return true;
    }
