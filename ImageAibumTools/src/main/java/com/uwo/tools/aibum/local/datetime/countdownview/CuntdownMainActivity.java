package com.uwo.tools.aibum.local.datetime.countdownview;
...
public class CuntdownMainActivity extends ActionBarActivity implements CountdownView.OnCountdownEndListener {

    public static void actionStart(Activity activity) {
        Intent intent = new Intent(activity, CuntdownMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuntdown_main);
