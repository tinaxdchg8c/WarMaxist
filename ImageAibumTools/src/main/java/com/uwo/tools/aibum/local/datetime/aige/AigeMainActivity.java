package com.uwo.tools.aibum.local.datetime.aige;
 ...
 */
public class AigeMainActivity extends Activity {

    public static void actionStart(Activity activity) {
        Intent intent = new Intent(activity, AigeMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aige_main);
...
//                    }
//                }
//                Toast.makeText(AigeMainActivity.this, result, Toast.LENGTH_LONG).show();
//            }
//        });
...
//        });
        ...
        btnPick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog dialog = new AlertDialog.Builder(AigeMainActivity.this).create();
                dialog.show();
                DatePicker picker = new DatePicker(AigeMainActivity.this);
                picker.setDate(2015, 10);
                picker.setMode(DPMode.SINGLE);
                picker.setOnDatePickedListener(new DatePicker.OnDatePickedListener() {
                    @Override
                    public void onDatePicked(String date) {
                        Toast.makeText(AigeMainActivity.this, date, Toast.LENGTH_LONG).show();
                        dialog.dismiss();
                    }
                });
