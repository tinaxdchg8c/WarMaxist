...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	public LoadAndDisplayImageTask(com.nostra13.universalimageloader.core.ImageLoaderEngine engine, com.nostra13.universalimageloader.core.ImageLoadingInfo imageLoadingInfo, Handler handler) {
		this.engine = engine;
	...
	private boolean resizeAndSaveImage(int maxWidth, int maxHeight) throws IOException {
		...
		if (targetFile != null && targetFile.exists()) {
			...
			com.nostra13.universalimageloader.core.DisplayImageOptions specialOptions = new DisplayImageOptions.Builder().cloneFrom(options)
